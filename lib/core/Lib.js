...
module.exports = {
  ...
  url:require('url'),
  ejs:require('ejs'),
  pager:require('calipso/utils/pager'),
  prettyDate:require('calipso/utils/prettyDate.js'),
  prettySize:require('calipso/utils/prettySize.js'),
  crypto:require('calipso/utils/crypto.js'),
